"""
Django settings for cmmchandler project.
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": ("policies.auth.CookieJWTAuthentication",),
...
WSGI_APPLICATION = "cmmchandler.wsgi.application"
